(function(){
    ...
    .controller('SimpleShapesController', ['$scope','$rootScope','$timeout','canvas','simpleShapes', SimpleShapesController]);

    function SimpleShapesController($scope, $rootScope, $timeout, canvas, simpleShapes) {
        ...
        canvas.fabric.on('object:selected', function(object) {
            if ($rootScope.activeTab !== 'simple-shapes')
                return;
